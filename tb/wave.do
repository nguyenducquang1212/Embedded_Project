...
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/clk
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/reset_n
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/sensor1
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/sensor2
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/sensor3
add wave -noupdate -expand -group Controller -expand /top_tb/DUT/non_stop_ETC/cotroller_DUT/valid_Epass
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/enable
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/num_veh
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/done
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/init
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/count
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/cal
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/up
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/down
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/en
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/dis
add wave -noupdate -expand -group Controller /top_tb/DUT/non_stop_ETC/cotroller_DUT/reg_sensor3
