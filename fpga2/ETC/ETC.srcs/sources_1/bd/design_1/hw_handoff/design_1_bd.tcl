...
proc create_root_design { parentCell } {
  ...
  # Create instance: non_stop_ETC_0, and set properties
  set block_name non_stop_ETC
  set block_cell_name non_stop_ETC_0
  if { [catch {set non_stop_ETC_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $non_stop_ETC_0 eq "" } {
  ...
  connect_bd_net -net enable_1 [get_bd_ports enable] [get_bd_pins non_stop_ETC_0/enable]
  connect_bd_net -net non_stop_ETC_0_barrier [get_bd_ports barrier] [get_bd_pins non_stop_ETC_0/barrier]
  connect_bd_net -net non_stop_ETC_0_done_speed [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins non_stop_ETC_0/done_speed]
  connect_bd_net -net non_stop_ETC_0_led1 [get_bd_ports led1] [get_bd_pins non_stop_ETC_0/led1]
  connect_bd_net -net non_stop_ETC_0_led2 [get_bd_ports led2] [get_bd_pins non_stop_ETC_0/led2]
  connect_bd_net -net non_stop_ETC_0_led3 [get_bd_ports led3] [get_bd_pins non_stop_ETC_0/led3]
  connect_bd_net -net non_stop_ETC_0_led4 [get_bd_ports led4] [get_bd_pins non_stop_ETC_0/led4]
  connect_bd_net -net non_stop_ETC_0_led5 [get_bd_ports led5] [get_bd_pins non_stop_ETC_0/led5]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins non_stop_ETC_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins non_stop_ETC_0/reset_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sensor1_1 [get_bd_ports sensor1] [get_bd_pins non_stop_ETC_0/sensor1]
  connect_bd_net -net sensor2_1 [get_bd_ports sensor2] [get_bd_pins non_stop_ETC_0/sensor2]
  connect_bd_net -net sensor3_1 [get_bd_ports sensor3] [get_bd_pins non_stop_ETC_0/sensor3]
  connect_bd_net -net valid_Epass_1 [get_bd_ports valid_Epass] [get_bd_pins non_stop_ETC_0/valid_Epass]
