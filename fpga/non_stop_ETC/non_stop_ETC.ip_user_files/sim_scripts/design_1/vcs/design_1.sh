...
#
# Generated by Vivado on Wed Jun 15 22:06:03 +07 2022
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../non_stop_ETC.srcs/sources_1/bd/design_1/ipshared/4903" +incdir+"/tools/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../non_stop_ETC.srcs/sources_1/bd/design_1/ipshared/4903" +incdir+"/tools/Xilinx/Vivado/2018.1/data/xilinx_vip/include" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/data5/workspace/quangnd1/sip_training/quangnd1/Embedded_Project/fpga/non_stop_ETC/non_stop_ETC.cache/compile_simlib/vcs"
  fi
