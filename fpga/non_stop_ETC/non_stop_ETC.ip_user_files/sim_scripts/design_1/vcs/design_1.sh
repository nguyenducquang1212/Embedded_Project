...
#
# Generated by Vivado on Sat Jun 25 10:46:07 +07 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../non_stop_ETC.srcs/sources_1/bd/design_1/ipshared/85a3" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../non_stop_ETC.srcs/sources_1/bd/design_1/ipshared/85a3" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/quangnd12/EmbeddedSystem/Embedded_Project/fpga/non_stop_ETC/non_stop_ETC.cache/compile_simlib/vcs"
  fi
